...
class Solution:
    ...
    def solve_part_2(self):
        answer = 0
        start = 2000  # Good starting point after bissecting roughly
        while True:
            x = start
            y = start
            is_beam = False
            while not is_beam:
                ...
                while op != 99:
                    ...
                    if op1 == 99:
                        break
                is_beam = out1 == 1
            square_coos = [(x - 99, y), (x, y + 99), (x - 99, y + 99)]
            is_square = True
            for coos in square_coos:
                comp = IntCodeComputer(deepcopy(self.input), inputs=[coos[0], coos[1]])
                op = 0
                while op != 99:
                    out1, op1 = comp.run()
                    if op1 == 99:
